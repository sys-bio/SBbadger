...
def read_and_pass_distributions():
    pass
...
def get_antimony_script2(reaction_list, ic_params, kinetics, rev_prob, add_enzyme):
    n_species = reaction_list[0]
    reaction_list_copy = deepcopy(reaction_list)
...
def get_antimony_script(floating_ids, boundary_ids, reaction_list, ic_params, kinetics, rev_prob, add_enzyme):
